...
#define LL_USART_SR_NORMAL                        USART_SR_NORMAL                 /*!< NORMAL line detected flag */
...
/** @defgroup USART_LL_EC_IT IT Defines
  ...
  * @{
  */
#define LL_USART_CR1_NORMALIE                     USART_CR1_NORMALIE              /*!< NORMAL interrupt enable */
...
/** @defgroup USART_LL_EC_WAKEUP Wakeup
  * @{
  */
#define LL_USART_WAKEUP_NORMALLINE                0x00000000U           /*!<  USART wake up from Mute mode on NORMAL Line */
...
/**
  ...
  *         @arg @ref LL_USART_WAKEUP_NORMALLINE
...
/**
  * @brief  Check if the USART NORMAL line detected Flag is set or not
  * @rmtoll SR           NORMAL          LL_USART_IsActiveFlag_NORMAL
  * @param  USARTx USART Instance
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_USART_IsActiveFlag_NORMAL(const USART_TypeDef *USARTx)
{
  return (READ_BIT(USARTx->SR, USART_SR_NORMAL) == (USART_SR_NORMAL));
}
...
/**
  ...
  *         NE, FE, ORE, NORMAL would also be cleared.
...
/**
  ...
  *         register followed by a read access to the USARTx_DR register.
  * @note   Please also consider that when clearing this flag, other flags as
  *         PE, NE, ORE, NORMAL would also be cleared.
...
/**
  ...
  *         register followed by a read access to the USARTx_DR register.
  * @note   Please also consider that when clearing this flag, other flags as
  *         PE, FE, ORE, NORMAL would also be cleared.
...
/**
  ...
  *         register followed by a read access to the USARTx_DR register.
  * @note   Please also consider that when clearing this flag, other flags as
  *         PE, NE, FE, NORMAL would also be cleared.
...
/**
  * @brief  Clear NORMAL line detected Flag
  * @note   Clearing this flag is done by a read access to the USARTx_SR
  *         register followed by a read access to the USARTx_DR register.
  * @note   Please also consider that when clearing this flag, other flags as
  *         PE, NE, FE, ORE would also be cleared.
  * @rmtoll SR           NORMAL          LL_USART_ClearFlag_NORMAL
  * @param  USARTx USART Instance
  * @retval None
  */
__STATIC_INLINE void LL_USART_ClearFlag_NORMAL(USART_TypeDef *USARTx)
{
  __IO uint32_t tmpreg;
  tmpreg = USARTx->SR;
  (void) tmpreg;
...
/**
  ...
  * @rmtoll CR1          NORMALIE        LL_USART_EnableIT_NORMAL
  * @param  USARTx USART Instance
  * @retval None
  */
__STATIC_INLINE void LL_USART_EnableIT_NORMAL(USART_TypeDef *USARTx)
{
  ATOMIC_SET_BIT(USARTx->CR1, USART_CR1_NORMALIE);
}
...
/**
  ...
  * @rmtoll CR1          NORMALIE        LL_USART_DisableIT_NORMAL
  * @param  USARTx USART Instance
  * @retval None
  */
__STATIC_INLINE void LL_USART_DisableIT_NORMAL(USART_TypeDef *USARTx)
{
  ATOMIC_CLEAR_BIT(USARTx->CR1, USART_CR1_NORMALIE);
}
...
/**
  * @brief  Check if the USART NORMAL Interrupt  source is enabled or disabled.
  * @rmtoll CR1          NORMALIE        LL_USART_IsEnabledIT_NORMAL
  * @param  USARTx USART Instance
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_USART_IsEnabledIT_NORMAL(const USART_TypeDef *USARTx)
{
  return (READ_BIT(USARTx->CR1, USART_CR1_NORMALIE) == (USART_CR1_NORMALIE));
}
