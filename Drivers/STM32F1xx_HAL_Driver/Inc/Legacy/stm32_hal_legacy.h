...
#define UART_WAKEUPMETHODE_NORMALLINE     UART_WAKEUPMETHOD_NORMALLINE
...
#define ETH_MAC_TXFIFO_NORMAL                           0x00000000U  /* Tx FIFO read status: NORMAL */
...
#define ETH_MAC_TRANSMITFRAMECONTROLLER_NORMAL          0x00000000U  /* MAC transmit frame controller: NORMAL */
...
#if defined(STM32F1)
#else
#define ETH_MAC_READCONTROLLER_NORMAL           0x00000000U  /* Rx FIFO read controller NORMAL state */
