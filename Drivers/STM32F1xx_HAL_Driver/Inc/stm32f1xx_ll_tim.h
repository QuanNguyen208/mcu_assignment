...
typedef struct
{
  ...
  uint32_t OCNORMALState;   /*!< Specifies the TIM Output Compare pin state during NORMAL state.
                               This parameter can be a value of @ref TIM_LL_EC_OCNORMALSTATE.

                               This feature can be modified afterwards using unitary function
                               @ref LL_TIM_OC_SetNORMALState().*/

  uint32_t OCNNORMALState;  /*!< Specifies the TIM Output Compare pin state during NORMAL state.
                               This parameter can be a value of @ref TIM_LL_EC_OCNORMALSTATE.
...
typedef struct
{
  ...
  uint32_t OSSIState;            /*!< Specifies the Off-State used in NORMAL state.
...
/** @defgroup TIM_LL_EC_OCNORMALSTATE Output Configuration NORMAL State
  * @{
  */
#define LL_TIM_OCNORMALSTATE_LOW                 0x00000000U             /*!<OCx=0 (after a dead-time if OC is implemented) when MOE=0*/
#define LL_TIM_OCNORMALSTATE_HIGH                TIM_CR2_OIS1            /*!<OCx=1 (after a dead-time if OC is implemented) when MOE=0*/
/**
  * @}
  */
...
#define LL_TIM_OSSI_ENABLE                     TIM_BDTR_OSSI           /*!< When inactive, OxC/OCxN outputs are first forced with their inactive level then forced to their NORMAL level after the deadtime */
/**
  * @}
  */
...
/**
  ...
  *         @arg @ref LL_TIM_OCNORMALSTATE_LOW or @ref LL_TIM_OCNORMALSTATE_HIGH
  * @retval None
  */
...
/**
  * @brief  Set the NORMAL state of an output channel
  * @note This function is significant only for the timer instances
  *       supporting the break feature. Macro IS_TIM_BREAK_INSTANCE(TIMx)
  *       can be used to check whether or not a timer instance provides
  *       a break input.
  * @rmtoll CR2         OIS1          LL_TIM_OC_SetNORMALState\n
  *         CR2         OIS1N         LL_TIM_OC_SetNORMALState\n
  *         CR2         OIS2          LL_TIM_OC_SetNORMALState\n
  *         CR2         OIS2N         LL_TIM_OC_SetNORMALState\n
  *         CR2         OIS3          LL_TIM_OC_SetNORMALState\n
  *         CR2         OIS3N         LL_TIM_OC_SetNORMALState\n
  *         CR2         OIS4          LL_TIM_OC_SetNORMALState
  * @param  TIMx Timer instance
  * @param  Channel This parameter can be one of the following values:
  *         @arg @ref LL_TIM_CHANNEL_CH1
  *         @arg @ref LL_TIM_CHANNEL_CH1N
  ...
  *         @arg @ref LL_TIM_CHANNEL_CH3N
  *         @arg @ref LL_TIM_CHANNEL_CH4
  * @param  NORMALState This parameter can be one of the following values:
  *         @arg @ref LL_TIM_OCNORMALSTATE_LOW
  *         @arg @ref LL_TIM_OCNORMALSTATE_HIGH
  * @retval None
  */
__STATIC_INLINE void LL_TIM_OC_SetNORMALState(TIM_TypeDef *TIMx, uint32_t Channel, uint32_t NORMALState)
{
  uint8_t iChannel = TIM_GET_CHANNEL_INDEX(Channel);
  MODIFY_REG(TIMx->CR2, (TIM_CR2_OIS1 << SHIFT_TAB_OISx[iChannel]),  NORMALState << SHIFT_TAB_OISx[iChannel]);
}

/**
  * @brief  Get the NORMAL state of an output channel
  * @rmtoll CR2         OIS1          LL_TIM_OC_GetNORMALState\n
  *         CR2         OIS1N         LL_TIM_OC_GetNORMALState\n
  *         CR2         OIS2          LL_TIM_OC_GetNORMALState\n
  *         CR2         OIS2N         LL_TIM_OC_GetNORMALState\n
  *         CR2         OIS3          LL_TIM_OC_GetNORMALState\n
  *         CR2         OIS3N         LL_TIM_OC_GetNORMALState\n
  *         CR2         OIS4          LL_TIM_OC_GetNORMALState
  * @param  TIMx Timer instance
  * @param  Channel This parameter can be one of the following values:
  *         @arg @ref LL_TIM_CHANNEL_CH1
  *         @arg @ref LL_TIM_CHANNEL_CH1N
  ...
  *         @arg @ref LL_TIM_OCNORMALSTATE_HIGH
  */
__STATIC_INLINE uint32_t LL_TIM_OC_GetNORMALState(const TIM_TypeDef *TIMx, uint32_t Channel)
{
  uint8_t iChannel = TIM_GET_CHANNEL_INDEX(Channel);
...
/**
  * @brief  Select the outputs off state (enabled v.s. disabled) in NORMAL and Run modes.
  * @note Macro IS_TIM_BREAK_INSTANCE(TIMx) can be used to check whether or not
  *       a timer instance provides a break input.
  * @rmtoll BDTR         OSSI          LL_TIM_SetOffStates\n
  *         BDTR         OSSR          LL_TIM_SetOffStates
  * @param  TIMx Timer instance
  * @param  OffStateNORMAL This parameter can be one of the following values:
  ...
  * @retval None
  */
__STATIC_INLINE void LL_TIM_SetOffStates(TIM_TypeDef *TIMx, uint32_t OffStateNORMAL, uint32_t OffStateRun)
{
  MODIFY_REG(TIMx->BDTR, TIM_BDTR_OSSI | TIM_BDTR_OSSR, OffStateNORMAL | OffStateRun);
}
